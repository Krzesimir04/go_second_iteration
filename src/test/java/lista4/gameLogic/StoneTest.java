...
// assertEquals(4, stone.getBreaths(), "Kamień w środku planszy powinien mieć 4
// oddechy");
// }
...
// assertEquals(3, black.getBreaths(), "Sąsiadujący kamień powinien zabrać jeden
// oddech");
// }
...
// assertThrows(IllegalStoneOfBothColorsException.class, () -> new Stone(1, 1,
// PlayerColor.BOTH, board),
